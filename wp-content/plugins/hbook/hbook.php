...
class HBook {
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_enqueue_script( 'hb-settings', plugin_dir_url( __FILE__ ) . 'admin-pages/js/hb-settings.js', array( 'jquery' ), $this->utils->get_file_version( 'hb-settings-js' ) );
		...
		if ( in_array( $page_name, $static_settings_pages ) ) {
			wp_enqueue_script( 'hb-settings-static', plugin_dir_url( __FILE__ ) . 'admin-pages/js/hb-settings-static.js', array( 'jquery' ), $this->utils->get_file_version( 'hb-settings-static-js' ) );
		}
		...
		if ( $page_name == 'reservations' ) {
			...
			wp_enqueue_script( 'hb-resa-cal', plugin_dir_url( __FILE__ ) . 'admin-pages/pages/reservations/resa-cal.js', array( 'jquery' ), $this->utils->get_file_version( 'resa-cal-js' ) );
		...
		wp_enqueue_style( 'hb-' . $page_name . '-style', plugin_dir_url( __FILE__ ) . 'admin-pages/pages/' . $page_name . '/' . $page_name . '.css', array(), $this->utils->get_file_version( $page_name . '-css' ) );
		wp_enqueue_script( 'hb-' . $page_name . '-script', plugin_dir_url( __FILE__ ) . 'admin-pages/pages/' . $page_name . '/' . $page_name . '.js', array( 'jquery' ), $this->utils->get_file_version( $page_name . '-js' ), true );
