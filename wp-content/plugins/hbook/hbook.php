...
class HBook
{
    ...
    public function __construct()
    {
        ...
        require HBOOK_ROOT_DIR . 'utils/plugin-id.php';
...
$thanks_msg = esc_html__('Thanks for using HBook plugin.', 'hbook-admin');
    ...
    {
        wp_enqueue_script('hb-global-js', HBOOK_ROOT_URI . 'admin-pages/js/hb-global.js', array('jquery'), $this->version);

        global $post_type;
        if ($post_type == 'hb_accommodation') {
            wp_enqueue_style('hb-accom-style', HBOOK_ROOT_URI . 'accom-post-type/accom-post-type.css', array(), $this->version);
            wp_enqueue_script('hb-accom-script', HBOOK_ROOT_URI . 'accom-post-type/accom-post-type.js', array('jquery'), $this->version);
    ...
    {
        wp_enqueue_style('hb-admin-pages-style', HBOOK_ROOT_URI . 'admin-pages/css/hb-admin-pages-style.css', array(), $this->version);
        wp_enqueue_script('hb-settings', HBOOK_ROOT_URI . 'admin-pages/js/hb-settings.js', array('jquery'), $this->version);
        ...
        if (in_array($page_name, $knockout_pages)) {
            wp_enqueue_script('hb-knockout', HBOOK_ROOT_URI . 'admin-pages/js/knockout-3.2.0.js', array('jquery'), $this->version);
            wp_enqueue_script('hb-settings-knockout', HBOOK_ROOT_URI . 'admin-pages/js/hb-settings-knockout.js', array('jquery'), $this->version);
        }
        ...
        if (in_array($page_name, $static_settings_pages)) {
            wp_enqueue_script('hb-settings-static', HBOOK_ROOT_URI . 'admin-pages/js/hb-settings-static.js', array('jquery'), $this->version);
        }

        if ($page_name == 'fees' || $page_name == 'options' || $page_name == 'rates') {
            wp_enqueue_script('hb-options-and-fees-script', HBOOK_ROOT_URI . 'admin-pages/js/hb-options-and-fees.js', array('jquery'), $this->version, true);
        }

        if ($page_name == 'fees' || $page_name == 'options' || $page_name == 'rates' || $page_name == 'reservations') {
            wp_enqueue_script('hb-price-utils', HBOOK_ROOT_URI . 'admin-pages/js/hb-price-utils.js', array('jquery'), $this->version, true);
        ...
        if ($page_name == 'reservations') {
            ...
            wp_enqueue_script('hb-resa-utils', HBOOK_ROOT_URI . 'admin-pages/pages/reservations/resa-utils.js', array('jquery'), $this->version);
            wp_enqueue_script('hb-resa-cal', HBOOK_ROOT_URI . 'admin-pages/pages/reservations/resa-cal.js', array('jquery'), $this->version);
            wp_enqueue_script('hb-resa-export', HBOOK_ROOT_URI . 'admin-pages/pages/reservations/resa-export.js', array('jquery'), $this->version);
            wp_enqueue_style('hb-resa-cal-style', HBOOK_ROOT_URI . 'admin-pages/pages/reservations/resa-cal.css', array(), $this->version);
        }

        if ($page_name == 'forms' || $page_name == 'contact') {
            wp_enqueue_script('jquery-ui-sortable');
            wp_enqueue_script('hb-knockout-sortable', HBOOK_ROOT_URI . 'admin-pages/js/knockout-sortable.min.js', array('jquery'), $this->version);
            wp_enqueue_script('hb-form-builder', HBOOK_ROOT_URI . 'admin-pages/js/hb-forms-and-contact.js', array('jquery'), $this->version);
            wp_enqueue_style('hb-form-builder-style', HBOOK_ROOT_URI . 'admin-pages/css/hb-form-builder.css', array(), $this->version);
        }
        ...
        wp_enqueue_style('hb-' . $page_name . '-style', HBOOK_ROOT_URI . 'admin-pages/pages/' . $page_name . '/' . $page_name . '.css', array(), $this->version);
        wp_enqueue_script('hb-' . $page_name . '-script', HBOOK_ROOT_URI . 'admin-pages/pages/' . $page_name . '/' . $page_name . '.js', array('jquery'), $this->version, true);
    ...
    public function hb_shortcodes($atts, $content = '', $shortcode_name)
    {
        ...
        require_once HBOOK_ROOT_DIR . 'front-end/shortcode_' . $shortcode_name . '.php';

        switch ($shortcode_name) {

            case 'hb_availability':
                wp_enqueue_script('hb-front-end-utils-script', HBOOK_ROOT_URI . 'front-end/js/utils.js', array('jquery'), $this->version, true);
