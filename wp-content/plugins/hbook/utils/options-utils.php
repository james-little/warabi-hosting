...
class HbOptionsUtils {
				...
				'options' => array(
					'hb_deposit_type' => array(
						...
						'choice' => array(
							...
							'one_night' => esc_html__( 'One night', 'hbook-admin' ),
	...
	public function init_options() {
		$options = array_merge( $this->misc_settings, $this->ical_settings, $this->payment_settings, $this->appearance_settings, $this->search_form_options, $this->accom_selection_options );
